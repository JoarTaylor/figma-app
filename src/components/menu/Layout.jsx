...
import { selectIsSignedIn, selectProfileImageSrc, selectUserCart } from "../../store/features/user/user.selector";
    ...
    <>
      <nav className="box-border  flex  w-full items-center justify-around">
          ...
          <div className="pb-3">
            { isSignedIn ? 
            <Link to="/dashboard">
              <img className=" rounded-full object-scale-down h-10" src={profileImageSrc} alt="" />
            </Link> : <SignIn/>
            }
          </div>
